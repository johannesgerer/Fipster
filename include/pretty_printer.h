...
// alternative: https://github.com/louisdx/cxx-prettyprint

// ############# Usage ##################:

// void print_line(v);
// void print_line(cout, v);
// void print_line(cout, v, special_formatter());
// string toS(v)
...
template <typename T> void print_line(const T& t) {
	print(cout, t);
	cout << endl;
}
...
template<typename type> string toS(const type& a)
{
	return toString(a);
}
